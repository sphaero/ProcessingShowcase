...
JVMFLAGS = -cp "./src:./src/pde:core.jar:minim.jar:jsminim.jar:$(PRC)/core/library/jogl-all.jar:$(PRC)/core/library/gluegen-rt.jar:mp3spi1.9.5.jar:tritonus_aos.jar:tritonus_share.jar"
JC = javac
