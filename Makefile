...
dist: classes
	...
	jar cvfm dist/birrrd2.jar MANIFEST.MF
	cd src; jar uvf ../dist/birrrd2.jar *.class
	cd src/pde;	jar uvf ../../dist/birrrd2.jar *.class
	cd src;	jar uvf ../dist/birrrd2.jar procmod/*.class
	jar uvf dist/birrrd2.jar data/* ${SKETCH_DIRS}
	mkdir .oscp5
	cd .oscp5; jar -xf ../oscP5.jar; rm -rf META-INF; jar uvf ../dist/birrrd2.jar *
	rm -rf .oscp5
	mkdir .picocli
	cd .picocli; jar -xf ../picocli-4.6.3.jar; rm -rf META-INF; jar uvf ../dist/birrrd2.jar *
	rm -rf .picocli
