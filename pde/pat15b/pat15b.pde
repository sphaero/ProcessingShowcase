...
int a = 4;
int dia = frameCount * a;
int randi = int(random(50));
  ...
  drawCircle(circleX, circleY, 100 + dia, color(255, 113, 52), 1 * randi); 
  if (dia > width) 
  {
    frameCount = 0; }
  ...
  drawCircle(circleX2, circleY2, 100 + dia, color(255, 113, 52), 1 * randi); 
  if (dia > width) 
  {
    frameCount = 0; }
  popMatrix();
